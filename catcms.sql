...
INSERT INTO `fa_admin` VALUES (1,'admin','Admin','a98d5ec209e89d3773cdd85779cbfb28','f1f0cd','/assets/img/avatar.png','admin@admin.com',0,1604754648,'127.0.0.1',1492186163,1604754648,'eeef813d-cf0a-4ef8-ab10-7631e2162087','normal');
...
INSERT INTO `fa_admin_log` VALUES (1,0,'Unknown','/EWmTvHGRgB.php/index/login?url=%2FEWmTvHGRgB.php','','{\"url\":\"\\/EWmTvHGRgB.php\",\"__token__\":\"***\",\"username\":\"admin\",\"password\":\"***\",\"captcha\":\"ouvl\"}','127.0.0.1','Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36',1604754641),(2,1,'admin','/EWmTvHGRgB.php/index/login?url=%2FEWmTvHGRgB.php','登录','{\"url\":\"\\/EWmTvHGRgB.php\",\"__token__\":\"***\",\"username\":\"admin\",\"password\":\"***\",\"captcha\":\"nsdw\"}','127.0.0.1','Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36',1604754648);

#
# Structure for table "fa_area"
#
...
INSERT INTO `fa_user` VALUES (1,1,'admin','admin','ead75ba7d69270956bb3420d19453170','691f05','admin@163.com','13888888888','',0,0,'2017-04-15','',0.00,0,1,1,1516170492,1516171614,'127.0.0.1',0,'127.0.0.1',1491461418,0,1516171614,'','normal','');
...
#
# Structure for table "fa_user_money_log"
#
...
#
# Data for table "fa_user_money_log"
#
